...
# %%
yolov5_fold0_tta_pred = pd.read_csv('./box_fusion_labels/yolov5/yolov5x_fold0_finetune768_nih.csv')
yolov5_fold1_tta_pred = pd.read_csv('./box_fusion_labels/yolov5/yolov5x_fold0_finetune768_nih.csv')
yolov5_fold2_tta_pred = pd.read_csv('./box_fusion_labels/yolov5/yolov5x_fold0_finetune768_nih.csv')
yolov5_fold3_tta_pred = pd.read_csv('./box_fusion_labels/yolov5/yolov5x_fold0_finetune768_nih.csv')
yolov5_fold4_tta_pred = pd.read_csv('./box_fusion_labels/yolov5/yolov5x_fold0_finetune768_nih.csv')

detectron2_r101fpn3x_pred = pd.read_csv('./box_fusion_labels/fasterrcnn/nih_pred_det.csv')

vfnet_r101fpn_pred = pd.read_csv('./box_fusion_labels/vfnet/vfnet_r101_8020_v1_epoch18_nih.csv')
vfnet_r101fpn_fold0_pred = pd.read_csv('./box_fusion_labels/vfnet/vfnet_r101_fold0_v3_epoch4_nih.csv')
vfnet_r101fpn_fold1_pred = pd.read_csv('./box_fusion_labels/vfnet/vfnet_r101_fold1_v4_epoch18_nih.csv')
vfnet_r101fpn_fold2_pred = pd.read_csv('./box_fusion_labels/vfnet/vfnet_r101_fold2_v4_epoch18_nih.csv')
vfnet_r101fpn_fold3_pred = pd.read_csv('./box_fusion_labels/vfnet/vfnet_r101_fold3_v1_epoch25_nih.csv')
vfnet_r101fpn_fold4_pred = pd.read_csv('./box_fusion_labels/vfnet/vfnet_r101_fold4_v3_epoch18_nih.csv')

test_meta = pd.read_csv('../input/nih_meta.csv')
merged_df = pd.DataFrame(columns=['image_id', 'PredictionString'])
ensemble_filename = 'yolov5x_fold0_1_2_3_4_768_conf_0.01_d2_r101fpn3x_054999_vfnet_r101fpn_8020_fold0_1_2_3_4_wbf_skbthr_0.03_v45_submission_rerun.csv'
...
for image_id in image_id_lst:
    ...
    merged_df = pd.concat([merged_df, merged_data], ignore_index=True)
